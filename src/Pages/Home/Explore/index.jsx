...
function ExploreHome() {
    ...
    return (
        <div className='explore py-[120px] mt-[120px]'>
            <div className="explore__container container mx-auto ">
                <div className="explore__heading">
                    <h1 className='text-2xl  md:text-4xl lg:text-5xl  '>Explore NFTs</h1>
                ...
                <div className="explore__cards">
                {
                    exploreData?.slice(0, 8).map(data => 
                        ...
                        <div className="card__img">
                                <Link state="Explore" to="/explore">    <img src={data?.img} alt="" /></Link>
                                    <div className="dot">
