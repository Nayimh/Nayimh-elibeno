      ...
      <div className="container mx-auto py-[80px] md:[py-120px]">
        <div className="grid gap-6">
          {wallets?.map((wallet) => (
            <div
              key={wallet?.id}
              className="bg-lightBlue lg:w-full flex flex-col lg:flex-row justify-between h-[362px] lg:h-[132px] items-center px-5 lg:px-[100px] py-4"
            >
              ...
              <div>
                <button className="text-white py-3 px-6 bg-darkBlue hover:bg-pink rounded-lg mt-4 lg:mt-0">
                  {" "}
                  Connect{" "}
                </button>
              </div>
